...
\reporttype{Preliminary version Report}
...
\fxnote*[draft]{deliverables is just used for the reports, maybe better toolchain and software}{openETCS project deliverables}
\end{abstract}
...
\fxnote*[draft]{abriviation without explanation}{EUC}
...
\fxwarning[draft]{better adopted grafic (ask Marc Behrens for draft)}
...
\fxwarning*[draft]{add source refference for TSI}{Technical Specifications for Interoperability (TSI)}
...
\fxnote*[draft]{connection not clearly expressed}{In terms of technology, this is mostly done by software.}
\fxwarning*[draft]{add source refference for SRS}{System Requirement Specification (SRS)}
...
\fxnote[draft]{[number] is already used for source references}
...
\begin{flushleft}
The objective of this subclause is to carry out the software- and software/hardware integration or the developed tools and to demonstrate that the software of the developed tools and the hardware interact correctly to perform their intended functions.
\end{flushleft}
{\footnotesize\sffamily\centering
\begin{longtable}{|p{2cm}|p{9cm}|p{3cm}|}
...
When using Scrum, it is highly recommended for SIL 4, that the software is designed with certain protections which assure that incompatible versions of software components cannot be combined and activated.
...
\fxnote*[draft]{maybe better encrypted to make a clearer seperation between programm coding and security coding}{9.1.4.10 ... code is coded}
